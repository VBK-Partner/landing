...
const PROJECTS = [
  ...
  {
    category: "Монтаж конструкцій",
    title: "Металевий ангар",
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Вибірка реалізованих об'єктів, які демонструють наш досвід та рівень
